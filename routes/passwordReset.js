...
// Your originals:
router.post('/request-password-reset', handleRequestReset);
router.post('/reset-password', handleResetPassword);

// Aliases to match reset.html:
router.post('/password/forgot', handleRequestReset);
